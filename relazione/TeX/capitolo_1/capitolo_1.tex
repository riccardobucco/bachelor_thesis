	...
	\section{Prodotti offerti}
		\subsection{Photo Books in un click}
			...
			\begin{multicols}{3}[\noindent PastBook permette di recuperare le immagini utilizzando uno dei seguenti servizi Web:]
				\begin{itemize}
					\item Instagram\input{TeX/capitolo_1/note/instagram.tex}
					\item Facebook\input{TeX/capitolo_1/note/facebook.tex}
					\item Flickr\input{TeX/capitolo_1/note/flickr.tex}
					\item Google Drive\input{TeX/capitolo_1/note/google_drive.tex}
					\item Dropbox\input{TeX/capitolo_1/note/dropbox.tex}
					\item OneDrive\input{TeX/capitolo_1/note/one_drive.tex}
					\item Picasa\input{TeX/capitolo_1/note/picasa.tex}
					\item Evernote\input{TeX/capitolo_1/note/evernote.tex}
					\item Box\input{TeX/capitolo_1/note/box.tex}
				\end{itemize}
			\end{multicols}
			\begin{figure}[H]
				\centering
