	...
	\section{Organizzazione aziendale}
		\subsection{Obiettivi e risultati attesi}
			...
			\subsubsection{Valorizzazione del capitale umano}
				...
				\input{capitolo_1/diagrammi/valorizzare_capitale_umano.tex}
		...
		\subsection{Componenti e relazioni organizzative}
			...
			\subsubsection{Struttura organizzativa}
				...
				\end{itemize}
				\input{capitolo_1/diagrammi/organigramma.tex}
			...
			\subsubsection{Coordinamento e controllo}
				...
				\emph{Trello}\input{capitolo_1/note/trello.tex}. Nello specifico, ogni dipendente ha accesso alle board riguardanti
			...
			\subsubsection{Gestione dei clienti}
				...
				\input{capitolo_1/diagrammi/cliente_fedele.tex}
			...
			\subsubsection{Comunicazione nell'azienda}
				...
				Il principale strumento informatico di supporto alla comunicazione è \emph{Slack}\input{capitolo_1/note/slack.tex}:
	...
	\section{Sviluppo software}
		\subsection{Metodologia di lavoro}
			\subsubsection{Tipico ciclo di vita del software}
				...
				\input{capitolo_1/diagrammi/ciclo_vita_software.tex}
		...
		\subsection{Tecnologie, tecniche e strumenti utilizzati}
			\subsubsection{Generazione di un Photo Book}
				...
				stabile ed affermata: \emph{WebKit}\input{capitolo_1/note/webkit.tex}. In particolare, l'algoritmo sviluppato da
				...
				\emph{headless browser}\input{capitolo_1/note/headless_browser.tex}. PastBook, per esempio, fa uso di Google Chrome
			...
			\subsubsection{API e Service}
				...
				\emph{load balancing}\input{capitolo_1/note/load_balancing.tex}, che permette maggiori livelli di scalabilità e
				...
				\end{itemize}
				\input{capitolo_1/diagrammi/infrastruttura_server.tex}
