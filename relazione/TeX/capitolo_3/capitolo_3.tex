	...
	\section{Metodologia agile}
		...
		\subsection{Consegne frequenti}
			...
			\begin{itemize}
				...
				priorità assoluta, poiché senza essa non avrei potuto ottenere un prototipo funzionante. Di conseguenza, l'attività di
	...
	\section{Attività preparatorie e di accompagnamento}
		\subsection{Configurazione dell'ambiente di lavoro}
			...
			\subsubsection{Scelta e configurazione degli emulatori di dispositivi mobile}
				...
				seconda caratteristica che lo rende appetibile: è possibile installare le applicazioni semplicemente trascinandole
				...
				Una volta scelto l'emulatore, ho speso un po di tempo a configurarlo affinché si interfacciasse in modo corretto con
	...
	\section{Sviluppo di PastBook Mobile SDK}
		\subsection{Autenticazione a Facebook e Instagram}
			\subsubsection{Studio del dominio e analisi dei requisiti}
				...
				\begin{itemize}
					...
					gestione di questo caso, avvisando in modo consono l'applicazione affinché essa decida cosa debba essere
					fatto.
			...
			\subsubsection{Implementazione dell'autenticazione a Facebook tramite un modulo Titanium}
				...
				di Titanium non fornisce questa possibilità. Poiché per l'azienda questa cosa non era accettabile, in comune accordo
		...
		\subsection{Interfaccia per API aziendali}
			...
			\subsubsection{Progettazione, implementazione e relativi problemi}
				...
				\end{itemize}
				L'implementazione di questa parte dell'SDK è stata fatta abbastanza in fretta perché l'azienda desiderava risultati
			...
			\subsubsection{Analisi del metodo per la creazione di un Photo Book}
				...
				\begin{itemize}
					...
					\begin{itemize}
						...
						Book;
					\end{itemize}
					\item la tipologia delle impostazioni di configurazione dei vari Service può variare; anche Service
	...
	\section{Sviluppo di My Year Photo Book}
		\subsection{Analisi dei requisiti}
			\subsubsection{Produzione di alcuni wireframe}
				...
				In seguito alla presentazione, ho discusso con il mio tutor su quali fossero effettivamente le funzionalità che avrei
		...
		\subsection{Progettazione}
			\subsubsection{Modularizzazione della struttura dell'applicazione}
				...
				È risultato presto ovvio che questa architettura non fosse utilizzabile e tanto meno manutenibile, in quanto le
			...
			\subsubsection{Utilizzo delle funzioni di PastBook Mobile SDK}
				...
				\begin{itemize}
					...
					callback permette all'applicazione di svolgere azioni con i risultati intermedi dell'elaborazione (per esempio
				...
				dell'applicazione risulti notevolmente semplificato a causa di ciò.
		\subsection{Implementazione delle schermate e dei relativi controller}
			\subsubsection{L'uso del framework MVC Alloy}
				...
				utilizzare. Inoltre, si possono aggiungere ulteriori voci di configurazione relative alle singole piattaforme di
			...
			\subsubsection{Intrattenimento dell'utente}
				...
				che sarebbero state eseguite in seguito ad ogni Service (in base alla categoria alla quale apparteneva). In
				...
				\input{TeX/capitolo_3/codice/launcher_schermata_attesa.tex}
				...
				\begin{itemize}
					...
					verso il basso.
				\end{itemize}
				Quando ho completato la realizzazione di questa schermata mi sono reso conto che avrei potuto ottimizzarla. Infatti,
				...
				Launcher di essere messo in pausa ed eventualmente fermato completamente.
				\input{TeX/capitolo_3/diagrammi/backbutton_schermata_attesa.tex}
				...
				completamente inutilizzabile. Appcelerator è a conoscenza di questo bug, ma non l'ha risolto durante la mia
			...
			\subsubsection{Visualizzazione del Photo Book}
				...
				l'utente. A partire da questa breve analisi, ho capito che la realizzazione di questo componente sarebbe stata
				troppo ardua con così poco tempo a disposizione. Inoltre, la difficoltà era enormemente aumentata dal fatto che il
				design doveva obbligatoriamente essere accattivante (si sarebbero dovute “sfogliare” le pagine come nella realtà).\\
				...
				soddisfare, mi è stato impossibile realizzare un layout responsive. Ho dovuto quindi procedere alla modifica
			...
			\subsubsection{Modifica del Photo Book}
				...
				\input{TeX/capitolo_3/codice/aggiornamento_copertina.tex}
			...
			\subsubsection{Checkout}
				...
				\begin{itemize}
					...
					utilizzare un software di cui non conoscevamo la qualità.
				\end{itemize}
				Alle considerazioni appena fatte si aggiunge il fatto che — a fine stage — la mia fiducia verso i moduli Titanium
		...
		\subsection{Verifica dei risultati ottenuti}
			...
			\end{itemize}
			In questo modo, quando un utilizzatore del prototipo incorreva in una situazione imprevista poteva inviare i dati raccolti
			...
			Per fare questo, ho utilizzato gli strumenti messi a disposizione dagli SDK di Android e iOS. Grazie ad essi, mi sono accorto di
	...
	\section{Analisi dei principali problemi}
		...
		\subsection{Difficoltà dovute al metodo di lavoro utilizzato}
			...
			\subsubsection{Modifiche all'architettura software}
				...
				è stato che l'architettura da me adottata inizialmente non era facilmente mantenibile, seppur funzionante. Il
