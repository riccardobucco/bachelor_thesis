	...
	\section{Sviluppo di PastBook Mobile SDK}
		...
		\subsection{Interfaccia per API aziendali}
			\subsubsection{Studio del dominio e analisi dei requisiti}
				...
				permettono di ottenere o aggiornare i token e i codici necessari per poter accedere a tutte le API e i Service. In
				particolare, esse permettono all'utente di scegliere se preferisce ottenere un account PastBook tramite email e
				password o se invece preferisce collegarsi utilizzando direttamente il proprio profilo Facebook.\\
