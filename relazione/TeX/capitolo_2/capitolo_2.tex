	...
	\section{Descrizione del progetto di stage}
		\subsection{Prodotti}
			\subsubsection{PastBook Mobile SDK}
				...
				\begin{itemize}
					...
					applicazionimobile all'interno dell'azienda. Il mio compito era quello di individuarle ed implementarle.
				\end{itemize}
				Opzionalmente, il PastBook mobile SDK avrebbe dovuto fornire un metodo che permettesse a uno sviluppatore
				...
				Appcelerator Titanium\input{TeX/capitolo_2/note/titanium.tex}.
			\subsubsection{My Year Photo Book}
				...
				Tale applicazione doveva essere utilizzabile sia su dispositivi con iOS\input{TeX/capitolo_2/note/ios.tex} che
				con Android\input{TeX/capitolo_2/note/android.tex}.\\
				L'applicazione rivestiva un ruolo fondamentale all'interno della strategia di PastBook. Il suo obiettivo era quello
				di mettere a disposizione degli utenti mobile parte dei servizi che sono disponibili nel sito web dell'azienda: in
				...
				senza che gli sviluppatori la dovessero modificare per poi rilasciare una nuova versione. Tutte le funzionalità
		...
		\subsection{Tecnologie}
			\subsubsection{Appcelerator Titanium}
				...
				funzionalità (in particolare Hockeyapp\input{TeX/capitolo_2/note/hockeyapp.tex} e
				Google Analytics\input{TeX/capitolo_2/note/google_analytics.tex}).\\
				...
				In secondo luogo, è stato scartato \emph{PhoneGap}\input{TeX/capitolo_2/note/phonegap.tex} — il principale
			...
			\subsubsection{Stripe}
				Stripe\input{TeX/capitolo_2/note/stripe.tex} è un servizio di pagamento digitale tramite internet. I metodi di
				pagamento accettati sono molteplici: carte di credito, carte di debito,
				Apple Pay\input{TeX/capitolo_2/note/apple_pay.tex} e Android Pay\input{TeX/capitolo_2/note/android_pay.tex}. Le
				...
				Esso funziona in modo molto simile a PayPal\input{TeX/capitolo_2/note/paypal.tex}, suo principale concorrente.
			...
			\subsubsection{Google Analytics e Google Tag Manager}
				...
				Google Tag Manager\input{TeX/capitolo_2/note/google_tag_manager.tex}, invece, è uno strumento gratuito che consente
