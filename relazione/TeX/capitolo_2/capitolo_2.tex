	...
	\section{Descrizione del progetto di stage}
		\subsection{Prodotti}
			...
			\subsubsection{My Year Photo Book}
				...
				presente sulla copertina). Inoltre, l'applicazione dovrebbe essere in larga parte configurabile dall'azienda senza
				che gli sviluppatori la debbano modificare per poi rilasciare una nuova versione. Tutte le funzionalità descritte
				dovrebbero essere implementate in modo tale che futuri sviluppatori mobile possano riutilizzarle senza doverle
				inventare da zero.\\
